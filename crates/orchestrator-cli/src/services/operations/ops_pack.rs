...
use crate::{
    conflict_error, invalid_input_error, not_found_error, print_ok, print_table, print_value, PackCommand,
...
fn print_pack_list_table(rows: &[PackListRow]) {
    ...
    let table_rows: Vec<Vec<String>> = rows
        ...
        .collect();
    print_table(&["NAME", "VERSION", "SOURCE", "ACTIVE", "TITLE"], &table_rows);
}
