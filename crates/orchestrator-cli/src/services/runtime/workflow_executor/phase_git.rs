...
pub(crate) fn is_git_repo(project_root: &str) -> bool {
...
pub(crate) fn git_has_pending_changes(cwd: &str) -> Result<bool> {
...
pub(crate) fn commit_implementation_changes(cwd: &str, commit_message: &str) -> Result<()> {
