...
/// observations. The plugin-host session module cannot depend on
/// daemon-runtime directly, so the observer trait lives there and the
/// metrics-aware implementation is wired here.
