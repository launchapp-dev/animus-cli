...
- **`docs/reference/workflow-yaml.md`** gained a `triggers:` section
  documenting the four trigger types (`file_watcher`, `webhook`,
  `github_webhook`, `plugin`) and cross-linking to the authoring guide.
