...
avm install v0.6.12            # download a kernel version
avm use --global v0.6.12       # machine default; per-project: `avm use v0.6.12` writes .animus-version
```

### Project setup: `animus.toml` (v0.6.12+)
...
```bash
# Specific version
ANIMUS_VERSION=v0.6.12 curl -fsSL https://raw.githubusercontent.com/launchapp-dev/animus-cli/main/scripts/install.sh | bash
