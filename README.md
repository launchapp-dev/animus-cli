...
avm install v0.6.14            # download a kernel version
avm use --global v0.6.14       # machine default; per-project: `avm use v0.6.14` writes .animus-version
```

### Project setup: `animus.toml` (v0.6.14+)
