...
```bash
# Specific version
ANIMUS_VERSION=v0.7.0-rc.44 curl -fsSL https://raw.githubusercontent.com/launchapp-dev/animus-cli/main/scripts/install.sh | bash
