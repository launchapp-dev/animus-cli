...
```bash
# Specific version
ANIMUS_VERSION=v0.7.0-rc.43 curl -fsSL https://raw.githubusercontent.com/launchapp-dev/animus-cli/main/scripts/install.sh | bash
