...
Current workspace CLI version: **v0.5.12**. See [CHANGELOG.md](../../CHANGELOG.md)
...
ANIMUS_VERSION=v0.5.12 curl -fsSL https://raw.githubusercontent.com/launchapp-dev/animus-cli/main/scripts/install.sh | bash
