...
Current workspace CLI version: **v0.5.14**. See [CHANGELOG.md](../../CHANGELOG.md)
...
ANIMUS_VERSION=v0.5.14 curl -fsSL https://raw.githubusercontent.com/launchapp-dev/animus-cli/main/scripts/install.sh | bash
