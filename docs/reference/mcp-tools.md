...
| Tool | Description | Key Parameters |
|---|---|---|
| `ao.workflow.notes.add` | Add a note to a workflow | `id`, `text` |
| `ao.workflow.notes.list` | List notes for a workflow | `id`, `limit`, `offset`, `max_tokens` |
