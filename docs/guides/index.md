...
- **[Working with Animus via MCP Tools](agents.md)** -- Complete guide to all 82 built-in MCP tools: JSON examples, common workflows, sequencing tips, pagination, and batch operations.
